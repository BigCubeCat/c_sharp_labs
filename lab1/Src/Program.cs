...
{
    /// <summary>
    /// Главный класс приложения. Отвечает за запуск и выполнение симуляции философов.
    /// </summary>
    public class Application
    {
        ...
        /// <summary>
        /// Основной метод запуска программы. Включает разбор аргументов, запуск симуляции и вывод результатов.
        /// </summary>
        public void Run(string[] args)
        {
            ...
            try
            {
                ParseArgs(args, out ProgramMode progMode, out string pathToConf, out bool helpOnly, out int updateTime, out countIterations);
                ...
                switch (progMode)
                {
                    ...
                    default:
                        throw new NotImplementedException("This mode not supported");
                }
            }
        ...
        private void MainLoop(int updateTime, int countIterations, bool useWaiter = false)
        {
            var philosophers = Loader.philosophers;
            var forks = Loader.forks;
        ...
        private void ParseArgs(string[] args, out ProgramMode progMode, out string pathToConf, out bool helpOnly, out int updateTime, out int countIterations)
        {
